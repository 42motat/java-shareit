...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> update(Long id, Long userId, UpdatedItemDto updatedItemDto) {
        return post("/" + id, userId, updatedItemDto);
    }
    ...
    public ResponseEntity<Object> createComment(Long id, Long userId, CommentDto commentDto) {
        ...
        return post("/" + id + "/comment", userId, params, commentDto);
    }
